...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/arviz-plots-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/arviz-plots-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add arviz-plots
# for installing globally
pixi global install arviz-plots
```
...
It is possible to list all of the versions of `arviz-plots` available on your platform:
...
```
pixi search arviz-plots --channel conda-forge
```
